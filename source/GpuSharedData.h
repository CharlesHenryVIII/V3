...
#define SLOT_VOXEL_INDICES_MIP1 1
#define SLOT_VOXEL_INDICES_MIP2 2
#define SLOT_VOXEL_INDICES_MIP3 3
#define SLOT_VOXEL_INDICES_MIP4 4
#define SLOT_VOXEL_INDICES_MIP5 5
#define SLOT_VOXEL_INDICES_MIP6 6
#define SLOT_VOXEL_INDICES_SAMPLER 0
#define SLOT_RANDOM_TEXTURE 7
#define SLOT_RANDOM_TEXTURE_SAMPLER 7
#define SLOT_VOXEL_MATERIALS 8
//Cube Draw call
#define SLOT_PRIMITIVE_TEXTURE 0
#define SLOT_PRIMITIVE_TEXTURE_SAMPLER 0
//Final Draw Call
